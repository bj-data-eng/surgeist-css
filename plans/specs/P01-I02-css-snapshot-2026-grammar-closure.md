...
- `catalog.non-property.baseline.rule.media.boundary` retains the balanced
  unknown MQ3 feature value `width: calc(1px)` as defined-false syntax without
  an `InvalidMediaQuery` diagnostic;
