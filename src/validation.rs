...
const SUPPORTED_PROPERTIES: &[SupportedProperty] = &[
    ...
    supported_property!("content", Content),
    supported_property!("content-visibility", ContentVisibility),
    supported_property!("list-style-type", ListStyleType),
    supported_property!("list-style-position", ListStylePosition),
    supported_property!("list-style-image", ListStyleImage),
    supported_property!("list-style", ListStyle),
    supported_property!("counter-reset", CounterReset),
    supported_property!("counter-increment", CounterIncrement),
    supported_property!("counter-set", CounterSet),
